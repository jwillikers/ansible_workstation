...
. Install the community collection from Ansible Galaxy.
+
[source,sh]
----
...
. Install the Unattended-Upgrades role from Ansible Galaxy.
+
[source,sh]
----
...
. Pull down the ansible_fish role.
+
[source,sh]
----
...
[source,sh]
----
➜ git clone https://github.com/jwillikers/ansible_workstation.git roles/ansible_workstation
----
